                      ...
                      <form action="../controller/login.php" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <button type="submit" name="submit" class="btn btn-lg btn-primary btn-block mb-4 w-100" disabled>
                                    Zaloguj się
                                  </button>
                            </div>
                            <div class="col-md-6 mb-4">
                                <a class="btn btn-lg btn-primary btn-block mb-4 w-100 disabled" href="indexrejestracja.php">
                                    Nie masz konta?
                                </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 p-2 text-center alert alert-primary w-100" role="alert">Jesteś zalogowany. Wybierz stronę w nawigacji.</div>
                        </div>
                        <?php
                          } else{
                        ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <button type="submit" name="submitlogin" class="btn btn-lg btn-primary btn-block mb-4 w-100">
                                    Zaloguj się
                                </button>
                            </div>
                            <div class="col-md-6 mb-4">
                                <a class="btn btn-lg btn-primary btn-block mb-4 w-100" href="indexrejestracja.php">
                                    Nie masz konta?
                                </a>
                            </div>
                        </div>
