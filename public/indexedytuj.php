                      ...
                      <form method="post">
                        ...
                        <div class="row">
                          <div class="col-md-3 mb-4">
                            <div class="form-outline">
                              <input type="text" name="imie" class="form-control" placeholder="Jan" value="<?php echo $value['student_imie'];?>"/>
                              <label class="form-label" style="color: rgb(232, 54, 54);">Imię</label>
                              <input type="hidden" name="id" value="<?php echo $value['student_id']; ?>">
                            </div>
                          </div>
                          <div class="col-md-3 mb-4">
                            <div class="form-outline">
                              <input type="text" name="nazwisko" class="form-control" placeholder="Kowalski" value="<?php echo $value['student_nazwisko'];?>"/>
                          ...
                          <div class="col-md-4 mb-2">
                            <select class="form-select" name="stanowisko"  aria-label="Default select example">
                              <option <?php echo ($value['student_stanowisko']=='')?'selected':''?> >-</option>
                              <option value="tester" <?php echo ($value['student_stanowisko']=='tester')?'selected':''?> >Tester</option>
                              <option value="programista" <?php echo ($value['student_stanowisko']=='programista')?'selected':''?>>Programista</option>
                              <option value="kierownik" <?php echo ($value['student_stanowisko']=='kierownik')?'selected':''?>>Kierownik</option>
                              <option value="productowner" <?php echo ($value['student_stanowisko']=='productowner')?'selected':''?>>Product owner</option>
                            </select>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 mb-2">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="plec" id="mezczyzna" value="mezczyzna" <?php echo ($value['student_plec']=='mezczyzna')?'checked':''?>>
                              <label class="form-check-label" for="flexRadioDefault1" style="color: rgb(232, 54, 54);">
                                Mężczyzna
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="plec" id="kobieta" value="kobieta" <?php echo ($value['student_plec']=='kobieta')?'checked':''?>>
                              <label class="form-check-label" for="flexRadioDefault1" style="color: rgb(232, 54, 54);">
                                Kobieta
                              </label>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-2 mb-2">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="hobby[]" value="Sport" id="sport" disabled>
                              <label class="form-check-label" for="sport">
                                Sport
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="hobby[]" value="Kino" id="kino" disabled>
                          ...
                          <div class="col-md-2 mb-2">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="hobby[]" value="Teatr" id="teatr" disabled>
                              <label class="form-check-label" for="teatr">
                                Teatr
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="hobby[]" value="Muzyka" id="muzyka" disabled>
                          ...
                          <div class="col-md-6 mb-2">
                            <select class="form-select" name="jezykprogramowania"  aria-label="Default select example" multiple>
                              <option value="php" <?php echo ($value['student_jezykprogramowania']=='php')?'selected':''?>>PHP</option>
                              <option value="java" <?php echo ($value['student_jezykprogramowania']=='java')?'selected':''?>>Java</option>
                              <option value="c+" <?php echo ($value['student_jezykprogramowania']=='c+')?'selected':''?>>C++</option>
                              <option value="c#" <?php echo ($value['student_jezykprogramowania']=='c#')?'selected':''?>>C#</option>
                              <option value="python" <?php echo ($value['student_jezykprogramowania']=='python')?'selected':''?>>Python</option>
                              <option value="javascript" <?php echo ($value['student_jezykprogramowania']=='javascript')?'selected':''?>>JavaScript</option>
                            </select>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-2">
                            <div class="form-group">
                              <textarea class="form-control" name="zainteresowania" id="zain" row-2><?php echo $value['student_zainteresowania']?></textarea>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <button type="submit" name="submitedytuj" class="btn btn-primary w-100">
                              Edytuj
                            </button>
                          </div>
                          <div class="col-md-4">
                            ...
                            if (isset($_POST['submitedytuj'])){
                                $tabela = "studenci";
                                $pola = array(
                                    "student_imie" => $_POST['imie'],
                                    "student_nazwisko" => $_POST['nazwisko'],
                                ...
                                $updateDane = $db->update($tabela, $pola, $where);
                                if ($updateDane) {
                                  echo "<script>alert('Pomyślnie zmieniono dane!')</script>";
                                } else {
                                  echo "<script>alert('Nie udało się zmienić danych.')</script>";
                                }
                            }
                            ?>
                          <div class="col-md-2">
